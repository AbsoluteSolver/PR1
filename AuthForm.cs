...
namespace PR1
{
    public partial class AuthForm : Form
    {
        ...
        public AuthForm()
        {
            ...
            connection = new NpgsqlConnection("Host=localhost;Port=5432;Database=YP_DB;Username=postgres;Password=1219;");
            connection.Open();
        }
        ...
        {
            command = new NpgsqlCommand("select count(*) from пользователи where логин = @Username AND пароль = @Password", connection);
